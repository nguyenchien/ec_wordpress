                    ...
                    <div class="row">
                        <div class="box-nav-seach flexbox align-items-center justify-content-between">
                            <ul class="list-nav flexbox">
                                ...
                                <li class="item-nav">
                                    <a class="linkto" href="https://www.wargo.jp/cat-lover">猫雑貨</a>
                                </li>
                                <li class="item-nav">
                                    <a class="linkto" href="https://www.wargo.jp/products/list1587.html">石鹸</a>
                                </li>
                            </ul>
            ...
            <div class="left-menu-sidebar">
                ...
                <div class="wrap-menu-sb-v2 wrap-menu-sb-bottom-v2">
                    ...
                    <ul class="list-menu-sb-bottom-v2">
                        ...
                        <li class="item-menu"><a href="/cat-lover">猫雑貨</a></li>
                        <li class="item-menu"><a href="https://www.wargo.jp/products/list1587.html">石鹸</a></li>
                        <li class="item-menu"><a href="https://shop-list.wargo.jp/wargo">店舗</a></li>
                    </ul>
                </div>
            </div>
        </div>
